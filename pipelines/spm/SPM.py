...
try:
    from .SD15 import generate_images_with_spm_sd15
except ImportError:
    from SD15 import generate_images_with_spm_sd15
    ...
    **kwargs,
    ...
    if family not in SUPPORTED_SD_FAMILIES:
        raise NotImplementedError(
            f"SPM currently supports SD15 only, got model_family={family}, model_name={model_name}."
        )
    return generate_images_with_spm_sd15(
...
generate_images_with_sd = generate_images_with_spm
